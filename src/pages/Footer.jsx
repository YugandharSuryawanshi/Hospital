            ...
            <div className="container-fluid bg-dark p-5 text-white">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <h6><i class="fa-solid fa-location-dot"></i>Vinayak Chowk, Dhule <br /> Maharashtra</h6>
                        <p className="font-weight-bold"><i class="fa-solid fa-phone-flip"></i> 0000 000 0123</p>
                        <p className="font-weight-bold"><i class="fa-solid fa-envelope"></i> vinayakhospitalcashless@gmail.com</p>
                    </div>
